/*
    ...
    Description:
        This function generate unit data and obtain various skill values of a specified unit and stores them in an array.
...
private _unitData = [_className, name _unit, _skillArray];
